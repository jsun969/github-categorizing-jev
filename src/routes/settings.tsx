    ...
    <div className="max-w-2xl space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted">
          Manage tokens for loading and classifying your GitHub stars.
        </p>
      </div>
        ...
        <Card>
          <Card.Header>
            ...
            <Card.Description id="token-storage-hint">
              Tokens stay on the local server and are never returned here. Leave
              a field blank to keep its saved token.
            </Card.Description>
          </Card.Header>
          ...
          <Card.Content className="flex flex-col gap-4">
            ...
            >
              ...
              <Description>
                Classifies repositories into your categories.
              </Description>
            ...
            >
              ...
              <Input autoCapitalize="none" spellCheck={false} />
              <Description>
                Reads your starred repositories; never writes to GitHub.
              </Description>
              {githubError ? <FieldError>{githubError}</FieldError> : null}
            </TextField>

            <p className="text-sm text-muted">
              Configured means saved, not validated. API access is checked when
              you load stars or classify repositories.
            </p>
          ...
          <Card.Footer className="flex flex-wrap items-center gap-3">
            ...
            <span className="basis-full text-sm text-muted" role="status">
              {isLoading
